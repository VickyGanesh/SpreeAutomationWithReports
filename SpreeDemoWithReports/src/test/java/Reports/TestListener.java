...
//        ExtentTestManager.getTest().log(Status.FAIL, "Test Failed");
        ...
        log.info("*** Test execution " + result.getMethod().getMethodName() + " failed...");
            ...
            try {
                ...
                File file = new File(reportsPath + fileSeperator + "SpreeDemoTestCase" + i);
                ...
                targetLocation = reportsPath + fileSeperator + "SpreeDemoTestCase" + i + fileSeperator + screenShotName;// define
                // location
